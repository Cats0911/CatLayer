...
if errorlevel 1 (
  ...
  echo Internet access is required once for this development build.
  exit /b 1
)
...
if "%BUILD_ONLY%"=="0" (echo [1/5] Building CatLayer.exe ...) else (echo [BUILD] Compiling CatLayer.exe ...)
...
echo [2/5] Building Uninstall.exe ...
...
:REGISTER
echo [4/5] Registering uninstaller ...
